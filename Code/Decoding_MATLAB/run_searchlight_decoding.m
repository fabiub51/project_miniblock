function run_searchlight_decoding(project_dir,subj, design)
    % This function runs the searchlight decoding analysis with specified subject, design.

    %% Initialize config
    cfg = decoding_defaults;
    cfg.analysis = 'searchlight';  % specify searchlight decoding 
    ...
    % Mask
    cfg.files.mask = fullfile(project_dir, "miniblock/Outputs/masking/group_mask.nii");
